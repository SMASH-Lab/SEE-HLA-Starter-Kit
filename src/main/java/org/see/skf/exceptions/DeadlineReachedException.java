...
public class DeadlineReachedException extends RuntimeException {
    public DeadlineReachedException(String message) {
        super(message);
    }

    public DeadlineReachedException(Throwable cause) {
        super(cause);
    }

    public DeadlineReachedException(String message, Throwable cause) {
        super(message, cause);
    }
}
